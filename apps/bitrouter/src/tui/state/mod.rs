...
pub mod diff;
use self::diff::{Line, unified_to_lines};
pub mod pane;
use self::pane::{Autonomy, Ownership, PaneKind, PaneState, PendingView, TailKind};
pub mod overlay;
use self::overlay::{
    Command, DEFAULT_LEADER, LeaderAction, Mode, PaletteState, PickerPurpose, PickerState,
    leader_action,
};
pub mod layout;
use self::layout::{ClickTarget, ClickZone, DetailLayout, Split};
...
mod tests {
    ...
    use super::overlay::{COMMANDS, LEADER_LEAVES, parse_leader};
    use super::*;
    use crate::risk::Risk;
