...
| **Agent protocols** | MCP + Skills | No | MCP + A2A |
...
**TL;DR** — OpenRouter is a cloud API marketplace for humans picking models. LiteLLM is a Python proxy for unifying provider SDKs. BitRouter is a Rust-native proxy purpose-built for autonomous agents — with agent protocols (MCP, Skills), guardrails, and agentic payments out of the box.
