...
- [`ACTIONS_SPEC.md`](ACTIONS_SPEC.md) — **proposed.** One actions table so
  the CLI leaf and the MCP tool that answer the same question share one
  report type, one implementation, and a guard test. Written for
