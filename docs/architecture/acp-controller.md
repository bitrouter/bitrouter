...
It supersedes two decisions from the retired ACP TUI design:
...
- The former `crates/bitrouter-sdk/src/acp/engine.rs` minted a BitRouter
...
- The former `crates/bitrouter-sdk/src/acp/down.rs` deliberately prevented the
