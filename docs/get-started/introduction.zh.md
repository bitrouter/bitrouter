...
[核心（Core）](/docs/get-started/self-hosted-and-cloud)**以 Apache 2.0 协议开源，可免费自托管**——自带密钥或运行本地模型即可，无需付费。[云（Cloud）](/docs/get-started/self-hosted-and-cloud)是可选的托管层，在其之上额外提供托管提供商、Agent 自主支付与账户级防护策略管理。完整的[模型与定价](/docs/get-started/models)目录见此。
