...
```text
registry/v0/nodes/ed25519_7F5k....json
```
...
4. 不包含 schema invalid、proof invalid、expired-too-far、seq regression 的 item。
...
| REG-7 | CI 拒绝 invalid proof、stale seq、invalid pricing、artifact mismatch |
